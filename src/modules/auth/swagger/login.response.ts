...
const validateError =
  '{"status":{"code":400,"message":"Bad Request"},"error":{"code":100422,"message":"VALIDATE_ERROR","errors":{"username":["username should not be empty"],"password":["password should not be empty","password must be a string"]}},"path":"/api/auth/login","timestamp":"2025-06-05T13:04:46.410Z"}';
